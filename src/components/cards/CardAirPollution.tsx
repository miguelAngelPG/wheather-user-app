...
export const CardAirPollution = () => {
    ...
    if (errorAirPollution || errorWeather) return (
        <CardWrapper borderRadius='20px'>
            <Box display='flex' justifyContent='center' alignItems='center' gap={1} sx={{minHeight:'300px'}}>
                <Typography variant="h6">Novedades no disponibles</Typography>
            </Box>
        </CardWrapper>
    )
    ...
    if (!airPollution || !currentWeather) return (
        <CardWrapper borderRadius='20px'>
            <Box display='flex' justifyContent='center' alignItems='center' gap={1} sx={{minHeight:'300px'}}>
                <Typography variant="h6">Sin datos actuales</Typography>
            </Box>
        </CardWrapper>
    )
